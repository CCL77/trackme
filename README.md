...
- `socket.js`: hooks into the GeoLocation API and transmits coordinates to the backend server `fork updated`
- `OSM Maps API`: displays current positions `fork updated`
